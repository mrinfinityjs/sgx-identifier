...
## Making it Production-Ready: Intel® SGX DCAP Integration
...
1.  **Intel® SGX DCAP Quote Verification Library (QVL)**
...
2.  **Intel® Provisioning Certificate Caching Service (PCCS)**
